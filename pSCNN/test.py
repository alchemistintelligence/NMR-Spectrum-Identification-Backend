...
from tensorflow.python.keras import layers, models, optimizers, callbacks, distribute
...
if __name__ == '__main__':
        ...
        file = 'C:/Pribadi/pSCNN-Backend/models/known/F1.zip'
        file_path = "C:/Pribadi/pSCNN-main/models/"
        ...
        query = read_bruker_h(file_path+'/F1', False, True)
